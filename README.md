...
Laravel Activity Tracker is an elegant debug assistant for the Laravel framework. Activity Tracker provides insight into the requests coming into your application, exceptions, log entries, database queries, queued jobs, mail, notifications, cache operations, scheduled tasks, variable dumps and more. Activity Tracker makes a wonderful companion to your local Laravel development environment.
...
Documentation for Activity Tracker can be found on the [Laravel website](https://laravel.com/docs/telescope).

## Contributing

Thank you for considering contributing to Activity Tracker! The contribution guide can be found in the [Laravel documentation](https://laravel.com/docs/contributions).
...
Laravel Activity Tracker is open-sourced software licensed under the [MIT license](LICENSE.md).
